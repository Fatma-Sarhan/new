...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{asset('theme/admin/css/skins/_all-skins.min.css')}}"> --}}
		{{-- <link rel="stylesheet" href="{{URL::asset('theme/admin/css/bootstrap-rtl.min.css')}}"> --}}
		...
		<div class="wrapper">
			<header class="main-header">
				...
				<a href="{{url('dashboard')}}" class="logo">
					...
					<span class="logo-lg"><b>Ostazy-Interface</b></span>
				</a>
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user user-menu">
								...
								@else
									<img alt="" src="{{asset('theme/extra-images/profile-img-01.jpg')}}" class="user-image" alt="User Image">
								@endif
								...
								<ul class="dropdown-menu">
									...
									<li class="user-header">
									 @if(! empty (Auth::user()->profile_image))
			                          ...
			                          @else
			                            <img alt="" src="{{asset('theme/extra-images/profile-img-01.jpg')}}" class="img-circle" alt="User Image">
			                          @endif
										<p>
											<a href="{{ url('/profile') }}">
											{{Auth::user()->name}} 
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="active treeview">
							<a href="{{url('/')}}">
								<i class="fa fa-home"></i> <span>Ostazy </span></i>
							</a>
						</li>
						<li class="active treeview">
						...
						<li class="treeview"><a href="{{url('/degree')}}"><i class="fa fa-graduation-cap"></i> <span>Degrees</span></a></li>
						<li class="treeview"><a href="{{url('/subject')}}"><i class="fa fa-book"></i> <span>Subjects</span></a></li>
					</ul>
				</section>
				<!-- /.sidebar -->
			</aside>
